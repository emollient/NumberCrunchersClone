...
import NumberMunchers


class NumberMunchersActivity(sugar3.activity.activity.Activity):
    def __init__(self, handle):
        super(NumberMunchersActivity, self).__init__(handle)

        self.paused = False

        # Create the game instance.
        self.game = NumberMunchers.NumberMunchersGame()
